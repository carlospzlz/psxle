...
typedef void (CALLBACK* PADpressKey)(int, int);
typedef void (CALLBACK* PADreleaseKey)(int, int);
...
extern PADpressKey         PAD1_pressKey;
extern PADreleaseKey       PAD1_releaseKey;
